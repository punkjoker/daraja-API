...
<html lang="en">
    <head>
        ...
        <title>Products | Dairy products</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="jumbotron home-spacer" id="products-jumbotron">
                <h1>Welcome to Kantes Dairy Management system</h1>
            ...
            <div class="row text-center" id="cameras">
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/Dairyproducts.png" alt="">
                        <div class="caption">
                            <h3>Milk 1Litre </h3>
            ...
            <div class="row text-center" id="dairy">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/milk.jpeg" alt="">
                        <div class="caption">
                            <h3>Youghurt </h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/healthiest-cheese.jpg" alt="">
                        <div class="caption">
                            <h3>Cheese</h3>
