...
<?php include('include/sidebar.php');?>
    ...
    <input type="date" class="form-control" name="fromdate" id="fromdate" value="" required='true' max="<?php echo date('Y-m-d'); ?>">
</div>
...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="todate" id="todate" value="" required='true' max="<?php echo date('Y-m-d'); ?>">
</div>
